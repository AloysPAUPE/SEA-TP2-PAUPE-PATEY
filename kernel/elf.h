...
class ElfFile {
  ...
  void CheckELF32Header(Elf32_Ehdr *elfHdr, uint64_t *err);
  void CheckELF64Header(Elf64_Ehdr *elfHdr, uint64_t *err);
...
public:
   ...
   */
  ElfFile(OpenFile *exec_file, char is32bits, uint64_t *err);
